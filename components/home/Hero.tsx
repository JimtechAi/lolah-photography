    ...
    <section className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-[100svh] items-center justify-start px-6 pb-20 pt-32 md:px-10 md:pt-36 lg:px-16">
        <div className="max-w-3xl text-left text-white">
          <p className="fade-in-up uppercase tracking-[6px] text-yellow-300/95 mb-3 sm:mb-4 text-xs sm:text-sm md:text-base">
            Luxury Photography Studio
          </p>

          <h1 className="fade-in-up delay-150 max-w-[660px] font-serif text-4xl sm:text-5xl md:text-7xl lg:text-[5.3rem] font-semibold leading-[1.08] tracking-[0.01em] text-[#fff9ee]">
            Capturing Life's Most
            <br />
            Meaningful Moments
          </h1>

          <p className="fade-in-up delay-300 mt-4 sm:mt-6 max-w-xl text-base sm:text-lg md:text-lg text-gray-200/95">
          ...
          <p className="fade-in-up delay-450 mt-3 sm:mt-5 text-xs sm:text-sm uppercase tracking-[0.2em] text-yellow-100/90">
            ★★★★★ Trusted by 300+ Happy Clients Across Nigeria
          </p>

          <p className="fade-in-up delay-450 mt-1 sm:mt-2 text-xs sm:text-sm text-gray-300">
            Based in Ibadan • Available Across Nigeria
          </p>

          <div className="fade-in-up delay-600 mt-8 sm:mt-10 flex flex-col justify-start gap-3 sm:gap-5 md:flex-row">
            <Link
              href="/booking"
              className="rounded-full bg-yellow-500 px-6 sm:px-8 py-4 sm:py-5 text-sm sm:text-base font-semibold text-black shadow-[0_10px_35px_rgba(234,179,8,0.34)] transition-all duration-300 hover:scale-[1.03] hover:bg-yellow-400 hover:shadow-[0_16px_45px_rgba(234,179,8,0.42)] active:scale-95 touch-manipulation text-center"
            >
              Book a Session
            </Link>
            ...
            <Link
              href="/#portfolio"
              className="rounded-full border border-white/80 bg-transparent px-6 sm:px-8 py-4 sm:py-5 text-sm sm:text-base text-center text-white shadow-[0_8px_24px_rgba(0,0,0,0.22)] transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.03] hover:border-yellow-400 hover:text-yellow-100 hover:shadow-[0_14px_34px_rgba(0,0,0,0.3)] active:scale-95 touch-manipulation"
            >
              View Portfolio
            </Link>
          </div>
